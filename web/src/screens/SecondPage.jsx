...
const Overlay = () => {
  ...
  return (
    <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", pointerEvents: "none", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", color: "white", zIndex: 9999 }}>
      <h1 ref={titleRef} onMouseEnter={() => soundManager.playHover()} onClick={() => soundManager.playClick()} style={{ fontSize: "5rem", fontWeight: "bold", letterSpacing: "-0.05em", margin: 0, fontFamily: "'Helvetica Neue', sans-serif", pointerEvents: "auto", cursor: "pointer", textShadow: "0 0 20px rgba(0,0,0,0.5)" }}>
        HOLOSTAGE
      </h1>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "40px", marginTop: "40px", alignItems: "start" }}>
            <div className="glass-panel tech-border" style={{ padding: "30px" }}>
              ...
              <div style={{ display: "flex", gap: "12px", marginTop: "20px" }}>
                <Link to="/city" className="glass-panel" style={{ padding: "12px 30px", cursor: "pointer", borderColor: "var(--holo-blue)", color: "var(--holo-blue)" }}>
                  Coming Soon!
                </Link>
